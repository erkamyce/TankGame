...
public class Player extends Entity {
	...
	public void getPlayerImage(){
		try	{
			...
			left1 = ImageIO.read(getClass().getResourceAsStream("/player/left_21.png"));
			left2 = ImageIO.read(getClass().getResourceAsStream("/player/left_22.png"));
			right1 = ImageIO.read(getClass().getResourceAsStream("/player/righ_21.png"));
	...
	public void update(){
			if(keyH.upPressed == true || keyH.downPressed == true || keyH.leftPressed == true || keyH.rightPressed == true){
				...
				//check Npc collision
				int npcIndex = gp.cChecker.checkEntity(this, gp.enemy);	
				contactMonster(npcIndex);
